...
import it.donatoleone.sqlutil.interfaces.StringSequence;
...
abstract class BaseWhere<N> implements Where<N> {
    ...
    public String getDebugSql() {
        if (operation.isSimple()) {
            return String.format("%s %s %s %s", decodeWhereType(), this.column, operation.stringValue(),
                    this.value instanceof StringSequence ? ((StringSequence) this.value).getDebugSql() : asString(this.value));
        }
