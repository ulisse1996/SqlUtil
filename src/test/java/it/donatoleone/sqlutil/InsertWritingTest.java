...
public class InsertWritingTest {
    ...
    private static final String FROM_INSERT_DEBUG = "INSERT INTO TABLE1 (COL1,COL2) SELECT COL3 , 33 FROM TABLE2 WHERE COL4 = 1";
    private static final String FROM_INSERT = "INSERT INTO TABLE1 (COL1,COL2) SELECT COL3 , 33 FROM TABLE2 WHERE COL4 = ?";
